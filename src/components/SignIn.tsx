...
export const SignIn: FC = () => {
  return (
    <div className="flex h-full flex-col justify-center pt-10 pb-12 sm:px-6 md:pt-14 lg:px-8">
            ...
            <div className="grid grid-cols-3 gap-3">
              <div>
                <button
                  ...
                  onClick={() =>
                    signIn("facebook", { callbackUrl: "/calendar" })
                  }
                >
              ...
              <div>
                {/* Instagram signin */}
                <button className="btn inline-flex w-full justify-center rounded-md border border-neutral-300 bg-white py-2 px-4 text-sm font-medium text-neutral-500 shadow-sm hover:bg-neutral-50"
            ...
            <div>
              ...
              <div className="mt-1">
                <input
                  ...
                  autoComplete="email"
                  required
                  className="block w-full appearance-none rounded-md border border-neutral-300 px-3 py-2 placeholder-neutral-400 shadow-sm focus:border-sky-500 focus:outline-none focus:ring-sky-500 sm:text-sm"
                />
              </div>
            </div>
