...
export const BookingDisplay: FC<BookingDisplayProps> = ({
  ...
  const [modifiedBooking, setModifiedBooking] =
    useState<ModifiedBooking | null>(null);
          ...
          <dl className="sm:divide-y sm:divide-gray-200">
            ...
            <div className="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5 sm:px-6">
              ...
              <dd className="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                {isEditing ? (
                  <DateSelector
                    dateRange={[modifiedBooking?.start || null, modifiedBooking?.end || null]}
            ...
            <div className="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5 sm:px-6">
              ...
              <dd className="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                {isEditing && modifiedBooking ? (
                  <LocationDropdown
                    selectedLocation={modifiedBooking.location}
                    setSelectedLocation={setModifiedBookingLocation}
                  />
                ) : (
              ...
              <div className="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5 sm:px-6">
                ...
                <dd className="mt-1 flex text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                  <div className="ml-auto">
                    <button
                      type="button"
                      className="mr-4 inline-flex items-center rounded-md border border-transparent bg-red-100 px-4 py-2 text-sm font-medium text-red-600 shadow-sm hover:bg-red-200 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
                      onClick={() => {
